...
**Vorna** یک ابزار تونل‌سازی هوشمند، سریع و سازگار با انواع شبکه‌ است که با استفاده از تکنولوژی **VxLAN** و پروتکل **UDP** توسعه یافته.  
هدف Vorna کاهش پیچیدگی‌های مرسوم در تونل‌سازی و ارائه‌ی عملکردی پایدار حتی در شرایطی‌ست که IPv6 مسدود یا محدود شده باشد.

این ابزار با فایل اجرایی اصلی `vorna.py` ارائه می‌شود و برای مدیران شبکه، توسعه‌دهندگان و کاربران حرفه‌ای طراحی شده که به دنبال راهکاری ساده، قابل‌اتکا و کم‌مصرف هستند.
